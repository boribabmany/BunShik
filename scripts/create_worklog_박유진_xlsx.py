...
summary_rows = [
    ...
    (2, 24, [(1, "담당자: 박유진 | 기간: 2026-07-13 ~ 2026-08-13", 2)]),
    (4, 24, [(1, "구분", 3), (2, "내용", 3)]),
    (5, 24, [(1, "총 커밋", 4), (2, "94건", 4)]),
    (6, 24, [(1, "작업 기간", 4), (2, "2026-07-13 ~ 2026-08-13 (32일)", 4)]),
...
summary_rows.append((16, 65, [(1, "요약: 고객용 키오스크의 프론트엔드 전 화면(홈·메뉴·장바구니·결제·주문완료)을 담당하고, 네이버페이·카카오페이·토스페이 결제 연동, 세트 메뉴·품절 로직, 다국어·반응형 대응, 자동 테스트 및 Playwright E2E 테스트를 수행함.", 5)]))
...
<body>
  ...
  <div class="subtitle">담당자: 박유진 · 기간: 2026-07-13 ~ 2026-08-13</div>
  <div class="summary">
    <div class="card"><strong>총 커밋</strong>94건</div>
    <div class="card"><strong>작업 기간</strong>32일</div>
  ...
  <div class="note"><b>업무 요약</b><br>고객용 키오스크의 프론트엔드 전 화면(홈·메뉴·장바구니·결제·주문완료)을 담당하고, 네이버페이·카카오페이·토스페이 결제 연동, 세트 메뉴·품절 로직, 다국어·반응형 대응, 자동 테스트 및 Playwright E2E 테스트를 수행함.</div>
