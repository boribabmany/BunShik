...
summary_rows = [
    ...
    (2, 24, [(1, "담당자: 강민준 | 기간: 2026-07-13 ~ 2026-08-13", 2)]),
    (4, 24, [(1, "구분", 3), (2, "내용", 3)]),
    (5, 24, [(1, "확인 가능한 작업일", 4), (2, "23일", 4)]),
...
<body>
  ...
  <div class="subtitle">담당자: 강민준 · 기간: 2026-07-13 ~ 2026-08-13</div>
  <div class="summary">
  ...
  <div class="source">작성 근거: DevProject Hub 워크스페이스 ID 5 WBS, 프론트·백엔드 Git 커밋 기록 및 2026-08-13 실제 작업 결과.</div>
</body>
</html>'''
